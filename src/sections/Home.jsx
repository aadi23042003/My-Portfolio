    ...
    <motion.section initial={{opacity:0}} animate={{opacity:1}} transition={{duration:3}} id='home' className='w-full h-screen bg-neutral-950 relative overflow-hidden'>
      ...
      <div className="relative overflow-hidden z-10 h-full w-full max-w-7xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2">
        ...
        <div>
          ...
          <motion.img initial={{opacity:0,scale:0.8}} animate={{opacity:1,scale:1}} transition={{duration:1,delay:2.5}} src={avatar} alt="Profile Image" className='hidden md:block absolute translate-x-1/2 -translate-y-1/2 h-[80vh] w-96 top-1/2 right-1/4 pointer-events-none select-none'></motion.img>
        </div>

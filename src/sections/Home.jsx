     ...
     <div className='mt-12 md:mt-16 flex justify-center items-center h-[90vh]'>
      <div className='flex ps-8 flex-col w-[100%] md:w-[50%] h-[100%] justify-center items-center p-3'>
        ...
        <div className='flex gap-4 mt-6'>
          <a download href="./Aditya_Rao_Resume.pdf" className='p-2 cursor-pointer font-semibold hover:scale-110 bg-blue-600 rounded-full text-white shadow-lg'>My Resume</a>

...
const Footer = () => {
  return (
    <div id='footer' className='h-[40vh] w-full bg-linear-to-r flex flex-col justify-center items-center text-cyan-100 from-neutral-900 via-blue-950 to-neutral-900'>
